...
show_help() {
    ...
    echo -e "  ./start.sh                # Interactive mode, menu-based selection"
    echo -e "  ./start.sh dev            # Start in development mode"
    echo -e "  ./start.sh prod           # Start in production mode"
    echo -e "  ./start.sh stop           # Stop all running processes"
    echo -e ""
