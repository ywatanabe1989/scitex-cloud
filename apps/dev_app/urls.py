...
urlpatterns = [
    ...
    path("design/code-blocks/", views.DesignCodeBlocksView.as_view(), name="design_code_blocks"),
    path("design/terminal-log/", views.DesignTerminalLogView.as_view(), name="design_terminal_log"),
