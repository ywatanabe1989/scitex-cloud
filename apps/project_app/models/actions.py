...
class Workflow(models.Model):
    ...
    yaml_content = models.TextField(
        help_text="YAML workflow definition content"
    )
    ...
    enabled = models.BooleanField(
        default=True,
        help_text="Whether workflow is enabled"
    )
    ...
    total_runs = models.IntegerField(
        default=0,
        help_text="Total number of runs"
    )
    ...
    def get_absolute_url(self):
        ...
        return reverse('user_projects:workflow_detail', kwargs={
...
class WorkflowRun(models.Model):
    ...
    started_at = models.DateTimeField(
        null=True,
        blank=True,
        help_text="Run start time"
    )
    completed_at = models.DateTimeField(
        null=True,
        blank=True,
        help_text="Run completion time"
    )
    duration_seconds = models.IntegerField(
        null=True,
        blank=True,
        help_text="Run duration in seconds"
    )
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.run_number:
            ...
            last_run = WorkflowRun.objects.filter(
    ...
    def get_absolute_url(self):
        """Get run detail URL"""
        from django.urls import reverse
        return reverse('user_projects:workflow_run_detail', kwargs={
...
class WorkflowJob(models.Model):
    ...
    name = models.CharField(
        max_length=200,
        help_text="Job name from workflow YAML"
    )
    job_id = models.CharField(
        max_length=100,
        help_text="Job identifier from workflow YAML"
    )
    ...
    started_at = models.DateTimeField(
        null=True,
        blank=True,
        help_text="Job start time"
    )
    completed_at = models.DateTimeField(
        null=True,
        blank=True,
        help_text="Job completion time"
    )
    duration_seconds = models.IntegerField(
        null=True,
        blank=True,
        help_text="Job duration in seconds"
    )
...
class WorkflowStep(models.Model):
    ...
    output = models.TextField(
        blank=True,
        help_text="Step output (stdout)"
    )
    error_output = models.TextField(
        blank=True,
        help_text="Step error output (stderr)"
    )
    ...
    duration_seconds = models.IntegerField(
        null=True,
        blank=True,
        help_text="Step duration in seconds"
    )
...
class WorkflowArtifact(models.Model):
    ...
    file_path = models.CharField(
        max_length=500,
        help_text="Path to artifact file"
    )
    ...
    expires_at = models.DateTimeField(
        help_text="Artifact expiration time"
    )
