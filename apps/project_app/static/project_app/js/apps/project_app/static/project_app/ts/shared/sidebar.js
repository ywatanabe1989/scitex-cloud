    ...
    async function loadProjectStats() {
        try {
            ...
            if (data.success) {
                ...
                if (watchCount)
                    watchCount.textContent = String(data.stats.watch_count);
                if (starCount)
                    starCount.textContent = String(data.stats.star_count);
                if (forkCount)
                    forkCount.textContent = String(data.stats.fork_count);
