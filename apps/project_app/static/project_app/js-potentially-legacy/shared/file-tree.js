 ...
 */
function isInCurrentPath(itemPath, currentPath) {
 ...
 */
export function buildTreeHTML(items, username, slug, level = 0) {
  let html = "";
 ...
 */
export async function loadFileTree(username, slug, containerId = "file-tree") {
  try {
