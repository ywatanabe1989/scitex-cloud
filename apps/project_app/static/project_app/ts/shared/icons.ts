...
(function() {
     ...
     */
    async function loadIcon(iconName: string, options: IconOptions = {}): Promise<string> {
        const {
            size = 16,
            classes = '',
            color = 'currentColor',
     ...
     */
    async function createIcon(iconName: string, options: IconOptions = {}): Promise<HTMLElement | null> {
