...
class CollaboratorAutocomplete {
    ...
    private setupElements(): void {
        const input = document.getElementById('collaboratorUsername') as HTMLInputElement;
        const dropdown = document.getElementById('collaborator-autocomplete') as HTMLDivElement;
    ...
    private renderResults(users: UserSearchResult[]): void {
        ...
        items.forEach(item => {
            item.addEventListener('click', () => this.selectUser(item as HTMLElement));
            item.addEventListener('mouseenter', () => this.highlightItem(item as HTMLElement, true));
            item.addEventListener('mouseleave', () => this.highlightItem(item as HTMLElement, false));
        });
