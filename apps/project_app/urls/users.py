...
urlpatterns = [
    ...
    path('settings/repositories/', repository_maintenance, name='repository_maintenance'),

    # Repository maintenance and health check APIs
    path('api/repository-health/', api_repository_health, name='api_repository_health'),
    path('api/repository-cleanup/', api_repository_cleanup, name='api_repository_cleanup'),
    path('api/repository-sync/', api_repository_sync, name='api_repository_sync'),
    path('api/repository-restore/', api_repository_restore, name='api_repository_restore'),
]
