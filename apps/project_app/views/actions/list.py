...
def actions_list(request, username, slug):
    ...
    # Get all workflows for this project  # noqa: F821 - TODO: Workflow model not yet implemented
    workflows = (
        Workflow.objects.filter(project=project)  # noqa: F821
        .annotate(
    ...
    # Get recent workflow runs (last 10)  # noqa: F821 - TODO: WorkflowRun model not yet implemented
    recent_runs = (
        WorkflowRun.objects.filter(workflow__project=project)  # noqa: F821
