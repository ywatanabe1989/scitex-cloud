...
def actions_list(request, username, slug):
    ...
    return render(request, 'project_app/actions/actions_list.html', context)
...
def workflow_detail(request, username, slug, workflow_id):
    ...
    return render(request, 'project_app/actions/workflow_detail.html', context)
...
def workflow_run_detail(request, username, slug, run_id):
    ...
    return render(request, 'project_app/actions/workflow_run_detail.html', context)
...
def workflow_create(request, username, slug):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'project_app/actions/workflow_editor.html', {
                'project': project,
    ...
    return render(request, 'project_app/actions/workflow_editor.html', context)
...
def workflow_delete(request, username, slug, workflow_id):
    ...
    return render(request, 'project_app/actions/workflow_delete_confirm.html', context)
