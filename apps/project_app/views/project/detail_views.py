...
# File: /home/ywatanabe/proj/scitex-cloud/apps/project_app/views/project/detail_views.py
# ----------------------------------------
"""
Project Detail Views Module

This module contains view functions for project detail pages:
- Project detail/overview (GitHub-style file browser)
- Project mode routing (writer, code, viz)
- Port proxy handling
"""
...
from .list_views import user_bio_page
