...
console.log("[DEBUG] apps/scholar_app/static/scholar_app/ts/search/drag-sort.ts loaded");
...
function initializeDragSort(): void {
    ...
    const resultsContainer = document.getElementById('scitex-results-container') as HTMLElement | null;
    if (!resultsContainer) {
...
function updateDraggableCards(): void {
    const resultCards = document.querySelectorAll('.result-card') as NodeListOf<HTMLElement>;
