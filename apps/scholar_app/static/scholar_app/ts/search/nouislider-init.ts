...
if (window.__nouisliderInitialized) {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // ============================================
        const yearSlider = document.getElementById('yearSlider') as NoUiSliderElement | null;
        if (yearSlider && !yearSlider.noUiSlider) {
            try {
                ...
                yearSlider.noUiSlider.on('update', function(values: string[], handle: number): void {
                    const minValue = values[0];
                    const maxValue = values[1];

                    const yearFromInput = document.getElementById('yearFromInput') as HTMLInputElement | null;
                    const yearToInput = document.getElementById('yearToInput') as HTMLInputElement | null;
                    const yearMinDisplay = document.getElementById('yearMinDisplay') as HTMLElement | null;
                    const yearMaxDisplay = document.getElementById('yearMaxDisplay') as HTMLElement | null;
        ...
        // ============================================
        const citationsSlider = document.getElementById('citationsSlider') as NoUiSliderElement | null;
        if (citationsSlider && !citationsSlider.noUiSlider) {
            try {
                ...
                // Sync slider to hidden inputs and display badges
                citationsSlider.noUiSlider.on('update', function(values: string[], handle: number): void {
                    const minValue = values[0];
                    const maxValue = values[1];

                    const citationsMinInput = document.getElementById('citationsMinInput') as HTMLInputElement | null;
                    const citationsMaxInput = document.getElementById('citationsMaxInput') as HTMLInputElement | null;
                    const citationsMinDisplay = document.getElementById('citationsMinDisplay') as HTMLElement | null;
                    const citationsMaxDisplay = document.getElementById('citationsMaxDisplay') as HTMLElement | null;
        ...
        // ============================================
        const impactFactorSlider = document.getElementById('impactFactorSlider') as NoUiSliderElement | null;
        if (impactFactorSlider && !impactFactorSlider.noUiSlider) {
            try {
                ...
                // Sync slider to hidden inputs and display badges
                impactFactorSlider.noUiSlider.on('update', function(values: string[], handle: number): void {
                    const minValue = values[0];
                    const maxValue = values[1];

                    const impactFactorMinInput = document.getElementById('impactFactorMinInput') as HTMLInputElement | null;
                    const impactFactorMaxInput = document.getElementById('impactFactorMaxInput') as HTMLInputElement | null;
                    const impactFactorMinDisplay = document.getElementById('impactFactorMinDisplay') as HTMLElement | null;
                    const impactFactorMaxDisplay = document.getElementById('impactFactorMaxDisplay') as HTMLElement | null;

                    if (impactFactorMinInput) impactFactorMinInput.value = minValue;
                    if (impactFactorMaxInput) impactFactorMaxInput.value = maxValue;
                    if (impactFactorMinDisplay) impactFactorMinDisplay.textContent = minValue;
                    if (impactFactorMaxDisplay) impactFactorMaxDisplay.textContent = maxValue;
                });
