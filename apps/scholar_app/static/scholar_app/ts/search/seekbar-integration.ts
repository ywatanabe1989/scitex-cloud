...
class ScholarSeekbarIntegration {
    ...
    private initYearSlider(urlParams: URLSearchParams): void {
        const container = document.getElementById('yearSlider') as HTMLElement | null;
        if (!container) return;
    ...
    private initCitationsSlider(urlParams: URLSearchParams): void {
        const container = document.getElementById('citationsSlider') as HTMLElement | null;
        if (!container) return;
    ...
    private initImpactFactorSlider(urlParams: URLSearchParams): void {
        const container = document.getElementById('impactFactorSlider') as HTMLElement | null;
        if (!container) return;
    ...
    private updateYearDisplay(values: SeekbarValues): void {
        const minDisplay = document.getElementById('yearMinDisplay') as HTMLElement | null;
        const maxDisplay = document.getElementById('yearMaxDisplay') as HTMLElement | null;
    ...
    private updateCitationsDisplay(values: SeekbarValues): void {
        const minDisplay = document.getElementById('citationsMinDisplay') as HTMLElement | null;
        const maxDisplay = document.getElementById('citationsMaxDisplay') as HTMLElement | null;
    ...
    private updateImpactFactorDisplay(values: SeekbarValues): void {
        const minDisplay = document.getElementById('impactFactorMinDisplay') as HTMLElement | null;
        const maxDisplay = document.getElementById('impactFactorMaxDisplay') as HTMLElement | null;
    ...
    private updateHiddenInputs(type: string, values: SeekbarValues): void {
        switch (type) {
            case 'year':
                ...
                if (yearFromInput) yearFromInput.value = Math.round(values.min).toString();
            ...
            case 'citations':
                ...
                if (citationsMinInput) citationsMinInput.value = Math.round(values.min).toString();
                if (citationsMaxInput) citationsMaxInput.value = Math.round(values.max).toString();
                break;

            case 'impactFactor':
                const impactMinInput = document.getElementById('impactFactorMinInput') as HTMLInputElement | null;
                const impactMaxInput = document.getElementById('impactFactorMaxInput') as HTMLInputElement | null;
