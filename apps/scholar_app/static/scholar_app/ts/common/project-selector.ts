...
document.addEventListener('DOMContentLoaded', (): void => {
    ...
    if (projectSelector) {
        ...
        projectSelector.addEventListener('change', function(this: HTMLSelectElement): void {
            if (this.value) {
        ...
        const savedProjectId: string | null = sessionStorage.getItem('scholar_selected_project_id');
        if (savedProjectId) {
