            ...
            <div class="recent-job-card" data-job-id="${job.id}" style="margin-bottom: 0.75rem; border-left: 3px solid ${statusColor}; padding: 0.75rem; background: var(--color-canvas-subtle); border-radius: 4px; position: relative;">
                ...
                ${job.status === 'completed' ? `
                    <div style="display: flex; gap: 0.5rem; margin-top: 0.5rem;">
                        <button onclick="saveJobToProject('${job.id}')" class="btn btn-primary" style="flex: 1; padding: 0.35rem 0.75rem; font-size: 0.75rem; margin: 0;">
                            <i class="fas fa-folder"></i> Save
                        </button>
                        <button onclick="downloadJob('${job.id}')" class="btn btn-primary" style="flex: 1; padding: 0.35rem 0.75rem; font-size: 0.75rem; margin: 0;">
