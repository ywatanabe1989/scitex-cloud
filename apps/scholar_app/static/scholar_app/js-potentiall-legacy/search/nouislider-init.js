    ...
    if (citationsSlider && !citationsSlider.noUiSlider) {
      try {
        ...
        const citationsMaxRange =
          parseInt(citationsSlider.dataset.max) || 12000;
        const citationsMax =
    ...
    if (impactFactorSlider && !impactFactorSlider.noUiSlider) {
      try {
        ...
        const impactMaxRange =
          parseFloat(impactFactorSlider.dataset.max) || 50.0;
        const impactMax =
        ...
        impactFactorSlider.noUiSlider.on("update", function (values, handle) {
          ...
          document.getElementById("impactFactorMinDisplay").textContent =
            minValue;
          document.getElementById("impactFactorMaxDisplay").textContent =
            maxValue;
        });
