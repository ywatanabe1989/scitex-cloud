...
urlpatterns = [
    ...
    path('api/preferences/', search_views.get_user_preferences, name='get_user_preferences'),
    path('api/preferences/save/', search_views.save_user_preferences, name='save_user_preferences'),
    ...
    path('api/saved-searches/', search_views.get_saved_searches, name='get_saved_searches'),
    path('api/saved-searches/<uuid:search_id>/delete/', search_views.delete_saved_search, name='delete_saved_search'),
    path('api/saved-searches/<uuid:search_id>/run/', search_views.run_saved_search, name='run_saved_search'),

    # Progressive search API endpoints
    path('api/search/arxiv/', search_views.api_search_arxiv, name='api_search_arxiv'),
    path('api/search/pubmed/', search_views.api_search_pubmed, name='api_search_pubmed'),
    path('api/search/semantic/', search_views.api_search_semantic, name='api_search_semantic'),
    ...
    path('api/search/biorxiv/', search_views.api_search_biorxiv, name='api_search_biorxiv'),
    ...
    path('api/export/bulk/', export_views.export_bulk_citations, name='export_bulk_citations'),
    path('api/export/collection/<uuid:collection_id>/', export_views.export_collection, name='export_collection'),

    # Personal Library API endpoints
    path('api/library/papers/', library_views.api_library_papers, name='api_library_papers'),
    path('api/library/collections/', library_views.api_library_collections, name='api_library_collections'),
    path('api/library/collections/create/', library_views.api_create_collection, name='api_create_collection'),
    path('api/library/papers/<uuid:paper_id>/update/', library_views.api_update_library_paper, name='api_update_library_paper'),
    path('api/library/papers/<uuid:paper_id>/remove/', library_views.api_remove_library_paper, name='api_remove_library_paper'),

    # Research Trend Analysis endpoints
    path('trends/', trending_views.research_trends, name='research_trends'),
    path('api/trends/papers/', trending_views.api_trending_papers, name='api_trending_papers'),
    path('api/trends/topics/', trending_views.api_trending_topics, name='api_trending_topics'),
    path('api/trends/authors/', trending_views.api_trending_authors, name='api_trending_authors'),
    path('api/trends/analytics/', trending_views.api_research_analytics, name='api_research_analytics'),

    # Collaborative Annotation System endpoints
    path('annotations/<uuid:paper_id>/', annotation_views.paper_annotations, name='paper_annotations'),
    path('api/annotations/<uuid:paper_id>/', annotation_views.api_paper_annotations, name='api_paper_annotations'),
    path('api/annotations/create/', annotation_views.api_create_annotation, name='api_create_annotation'),
    path('api/annotations/<uuid:annotation_id>/update/', annotation_views.api_update_annotation, name='api_update_annotation'),
    path('api/annotations/<uuid:annotation_id>/delete/', annotation_views.api_delete_annotation, name='api_delete_annotation'),
    path('api/annotations/<uuid:annotation_id>/vote/', annotation_views.api_vote_annotation, name='api_vote_annotation'),
    path('api/collaboration/groups/', annotation_views.api_collaboration_groups, name='api_collaboration_groups'),

    # Paper Similarity Recommendations endpoints
    path('api/recommendations/paper/<uuid:paper_id>/', annotation_views.paper_recommendations, name='paper_recommendations'),
    path('api/recommendations/user/', annotation_views.user_recommendations, name='user_recommendations'),
    ...
    path('api/bibtex/enrich/', bibtex_views.bibtex_enrich_sync, name='bibtex_enrich_sync'),
    ...
    path('api/bibtex/job/<uuid:job_id>/save-to-project/', bibtex_views.bibtex_save_to_project, name='bibtex_save_to_project'),
    path('api/bibtex/recent-jobs/', bibtex_views.bibtex_recent_jobs, name='bibtex_recent_jobs'),
    ...
    path('api/mock/get-citation/', search_views.mock_get_citation, name='mock_get_citation'),
