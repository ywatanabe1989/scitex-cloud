...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('Checking manuscripts for missing compile scripts...'))
        ...
        for manuscript in manuscripts:
            ...
            if dry_run:
                ...
                try:
                    ...
                    self.stdout.write(
                        self.style.ERROR(
                            f'Error processing {manuscript.title}: {e}'
                        )
                    )
                    error_count += 1
        ...
        # Summary
        self.stdout.write('\n' + '=' * 60)
        self.stdout.write(self.style.SUCCESS(f'Total manuscripts checked: {manuscripts.count()}'))
        self.stdout.write(self.style.SUCCESS(f'Compile scripts created/would create: {fixed_count}'))
