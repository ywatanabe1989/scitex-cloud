...
**Note:** Authentication templates have been moved to `apps/auth_app/templates/auth_app/` and monetization templates to `apps/billing_app/templates/billing_app/`.
...
### Billing/Monetization (→ apps/billing_app/templates/billing_app/)
- pricing.html
...
- Billing app templates: `/apps/billing_app/templates/billing_app`
