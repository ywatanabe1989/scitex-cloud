    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_type', models.CharField(choices=[('file', 'File Upload'), ('database', 'Database Connection'), ('api', 'API Endpoint'), ('realtime', 'Real-time Stream'), ('computed', 'Computed/Derived'), ('code_execution', 'Code Execution Results')], max_length=20)),
