    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "refresh_interval",
                    models.IntegerField(
                        blank=True, help_text="Refresh interval in seconds", null=True
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="viz_app.visualizationcomment",
                    ),
                ),
                (
                    "visualization",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                to="viz_app.visualizationtemplate",
            ),
        ),
        migrations.AddField(
            model_name="visualization",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="viz_app.DashboardVisualization", to="viz_app.visualization"
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="shared_visualizations",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["visualization", "date"],
                        name="viz_app_vis_visuali_bc0f34_idx",
                    )
                ],
        ...
        migrations.AddIndex(
            model_name="visualization",
            index=models.Index(
                fields=["owner", "status"], name="viz_app_vis_owner_i_46cb6a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="visualization",
            index=models.Index(
                fields=["is_public", "status"], name="viz_app_vis_is_publ_bb3e71_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "status"], name="viz_app_exp_user_id_f7e2b9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="exportjob",
            index=models.Index(
                fields=["status", "created_at"], name="viz_app_exp_status_681b09_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="dashboardvisualization",
