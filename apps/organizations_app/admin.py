...
from .models import Organization, OrganizationMembership, ResearchGroup, ResearchGroupMembership
...
class ResearchGroupMembershipAdmin(admin.ModelAdmin):
    ...
    list_filter = ['role', 'is_active', 'can_create_projects', 'can_invite_collaborators']
