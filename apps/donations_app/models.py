...
class Donation(models.Model):
    ...
    # Preferences
    is_public = models.BooleanField(default=False, help_text="Show donation publicly on supporters page")
    is_anonymous = models.BooleanField(default=False, help_text="Hide donor name if public")
...
class DonationTier(models.Model):
    ...
    name = models.CharField(max_length=100, help_text="Tier name (e.g., 'Bronze Supporter')")
    ...
    is_active = models.BooleanField(default=True, help_text="Whether this tier is currently offered")

    # Display order
    display_order = models.IntegerField(default=0, help_text="Order for displaying tiers")
    ...
    def get_donor_count(self):
        ...
        return Donation.objects.filter(
            status='completed',
            amount__gte=self.minimum_amount
        ).count()
