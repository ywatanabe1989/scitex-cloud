...
class UserProfile(models.Model):
    ...
    research_field = models.CharField(max_length=20, choices=RESEARCH_FIELD_CHOICES, blank=True)
    institution = models.CharField(max_length=200, blank=True)
    bio = models.TextField(max_length=500, blank=True)
    
    # Academic verification
    is_academic_verified = models.BooleanField(default=False, help_text="Email verified as academic institution")
...
class EmailVerification(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='auth_email_verifications')
