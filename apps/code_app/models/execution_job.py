"""
Code Execution Job Model

Main model for tracking code execution jobs.
"""
...
class CodeExecutionJob(models.Model):
    ...
    execution_time = models.FloatField(null=True, blank=True)  # Wall clock time
    ...
    def save(self, *args, **kwargs):
        ...
        is_newly_completed = (
            ...
            and CodeExecutionJob.objects.filter(pk=self.pk, status="completed").count() == 0
        )
