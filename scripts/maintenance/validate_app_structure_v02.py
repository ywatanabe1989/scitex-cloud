...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Validate Django app structure against FULLSTACK.md guidelines",
        epilog="Examples:\n"
               "  python scripts/maintenance/validate_app_structure.py project_app\n"
               "  python scripts/maintenance/validate_app_structure.py project_app writer_app\n"
               "  python scripts/maintenance/validate_app_structure.py",
    ...
    parser.add_argument(
        "apps",
        nargs="*",
        help="App names to validate (e.g., project_app, writer_app). If not provided, validates all apps."
    )
