...
export class ApiClient {
     ...
     * Make GET request
     */
    async get<T = any>(url: string, options?: ApiRequestInit): Promise<ApiResponse<T>> {
     ...
     * Make POST request
     */
    async post<T = any>(url: string, body?: any, options?: ApiRequestInit): Promise<ApiResponse<T>> {
     ...
     * Make PUT request
     */
    async put<T = any>(url: string, body?: any, options?: ApiRequestInit): Promise<ApiResponse<T>> {
        return this.request<T>(url, {
            ...options,
            method: 'PUT',
            body: JSON.stringify(body)
     ...
     * Make PATCH request
     */
    async patch<T = any>(url: string, body?: any, options?: ApiRequestInit): Promise<ApiResponse<T>> {
        return this.request<T>(url, {
            ...options,
            method: 'PATCH',
            body: JSON.stringify(body)
     ...
     * Make DELETE request
     */
    async delete<T = any>(url: string, options?: ApiRequestInit): Promise<ApiResponse<T>> {
     ...
     * Core request method
     */
    private async request<T = any>(url: string, options: ApiRequestInit = {}): Promise<ApiResponse<T>> {
