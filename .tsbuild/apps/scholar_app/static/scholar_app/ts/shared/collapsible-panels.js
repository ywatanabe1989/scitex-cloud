 ...
 */
function expandPanel(header, content, icon) {
    ...
    content.__heightObserver = observer;
}
/**
 ...
 * @param {HTMLElement} icon - The icon element to rotate
 */
function collapsePanel(header, content, icon) {
    ...
    const observer = content.__heightObserver;
    if (observer) {
        observer.disconnect();
        delete content.__heightObserver;
    }
}
/**
 ...
 */
function togglePanel(header, content, icon) {
 ...
 */
function initializePanel(header) {
 ...
 */
function initializeCollapsiblePanels(headerSelector = '.collapsible-header') {
 ...
 * @param {string} headerSelector - CSS selector for collapsible headers (default: '.collapsible-header')
 */
function expandAllPanels(headerSelector = '.collapsible-header') {
 ...
 * @param {string} headerSelector - CSS selector for collapsible headers (default: '.collapsible-header')
 */
function collapseAllPanels(headerSelector = '.collapsible-header') {
...
//# sourceMappingURL=collapsible-panels.js.map