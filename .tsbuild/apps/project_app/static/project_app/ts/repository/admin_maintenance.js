...
class RepositoryMaintenance {
    ...
    setupDialogBackdropClose() {
        ...
        window.confirmRestore = (name) => this.confirmRestore(name);
        window.confirmDelete = (name) => this.confirmDelete(name);
        window.confirmSync = (name) => this.confirmSync(name);
    }
    ...
    async syncRepository(projectSlug) {
    ...
    async restoreRepository(repositoryName, projectName) {
...
//# sourceMappingURL=admin_maintenance.js.map