...
!-- Author: ywatanabe
!-- File: /home/ywatanabe/proj/scitex-cloud/deployment/postgres/README.md
!-- --- -->
...
SciTeX Cloud uses PostgreSQL for both development and production environments. This provides:
...
See `../dotenvs/README.md` for complete documentation.
...
export SCITEX_CLOUD_DB_NAME_PROD="scitex_cloud_prod"
export SCITEX_CLOUD_DB_USER_PROD="scitex_prod"
export SCITEX_CLOUD_DB_HOST_PROD="your-db-host.com"
export SCITEX_CLOUD_DB_PORT_PROD="5432"
```
